                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <img src="<?php echo e(CustomHelper::displayImage(Auth::user()->avatar)); ?>" alt=""
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                ?>
                                <form action="<?php echo e(route('updateLeadProfile', $id)); ?>" enctype="multipart/form-data"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="first_name"
                                                            value="<?php echo e($aRow ? $aRow->first_name : ''); ?>"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="last_name"
                                                            value="<?php echo e($aRow ? $aRow->last_name : ''); ?>"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="contact"
                                                            ...
                                                            value="<?php echo e($aRow ? $aRow->contact : ''); ?>"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" class="form-control" name="email"
                                                            ...
                                                            value="<?php echo e($aRow ? $aRow->email : ''); ?>"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="textl" class="form-control" name="country"
                                                            id="basicpill-email-input"
                                                            value="<?php echo e($aRow ? $aRow->country : ''); ?>"
                                                            placeholder="Enter Your Email ID">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="company_name"
                                                            value="<?php echo e($aRow ? $aRow->company_name : ''); ?>"
                                                            id="basicpill-lastname-input"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <?php echo e(Form::select('country', ['' => 'Please Select'] + $aCountry, $aRow ? $aRow->country : null, ['id' => 'country-dropdown', 'class' => 'form-control', 'required' => 'required'])); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-11">
                                                            <h4><?php echo e(CustomHelper::getLeadDocumentType($kyc->doc_type)); ?>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="text-end">
                                                        <label
                                                            class="mt-3"><?php echo e($kyc->created_at->diffForHumans()); ?></label>
                                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(Auth::user()->dob ? date('d-m-Y', strtotime(Auth::user()->dob)) : ''); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/htmlpages/contacts-profile.blade.php ENDPATH**/ ?>