    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <?php if($aRow): ?>
                        <form method="POST" action="<?php echo e(route('client.update', $aRow->id)); ?>" enctype="multipart/form-data"
                            id="ClientForm" name="ClientForm">
                            <?php echo method_field('PUT'); ?>
                        <?php else: ?>
                            <form method="POST" action="<?php echo e(route('client.store')); ?>" enctype="multipart/form-data"
                                id="ClientForm" name="ClientForm">
                    <?php endif; ?>
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/clients/client-edit.blade.php ENDPATH**/ ?>