                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-grid">
                            ...
                            <a href="<?php echo e(route('calendar.event.create')); ?>" class="btn font-16 btn-primary mb-1"><i class="mdi mdi-plus-circle-outline"></i> Add Event</a>
                            <a href="<?php echo e(route('calendar.appointment.create')); ?>" class="btn font-16 btn-primary mb-1"><i class="mdi mdi-plus-circle-outline"></i> Appointments</a>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/tools/calendar/index.blade.php ENDPATH**/ ?>