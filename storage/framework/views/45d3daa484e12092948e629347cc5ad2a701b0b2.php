    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    <?php if($aRow): ?>
                        <form method="POST" action="<?php echo e(route('client-ticket.update', $aRow->id)); ?>"
                            enctype="multipart/form-data">
                            <?php echo method_field('PUT'); ?>
                        <?php else: ?>
                            <form method="POST" action="<?php echo e(route('client-ticket.store')); ?>" enctype="multipart/form-data">
                    <?php endif; ?>

                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <label for="formrow-firstname-input" class="form-label">Department</label>
                        <?php echo e(Form::select('department', ['' => 'Please Select'] + $aDepartment, $aRow ? $aRow->department : null, ['class' => 'form-control', 'required' => 'required'])); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="subject" name="subject"
                            ...
                            value="<?php echo e($aRow ? $aRow->subject : old('subject')); ?>" required placeholder="Subject">
                    </div>
                    <div class="mb-3">
                        <label for="formrow-email-input" class="form-label">Reporter</label>
                        <?php echo e(Form::select('reporter', ['' => 'Please Select'] + $getSalesAgent, $aRow ? $aRow->reporter : null, ['class' => 'form-control', 'required' => 'required'])); ?>

                    </div>
                    <div class="mb-3">
                        <label for="formrow-password-input" class="form-label">Priority</label>
                        <?php echo e(Form::select('priority', ['' => 'Please Select'] + $aPriority, $aRow ? $aRow->priority : null, ['class' => 'form-control', 'required' => 'required'])); ?>

                    </div>
                    <div class="mb-3">
                        <label for="formrow-email-input" class="form-label">Message</label>
                        <textarea id="taskdesc-editor" name="message"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="basicpill-address-input">Tags</label><br>
                        <div class="col-md-12">
                            <input type="text" value="" data-role="tagsinput" name="tags" class="form-control"
                                placeholder="Add tags" />
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="formrow-email-input" class="form-label">Files</label><br>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/clientTicket/add.blade.php ENDPATH**/ ?>