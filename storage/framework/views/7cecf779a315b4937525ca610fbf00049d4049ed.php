                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0">
                                    ...
                                    <a href="index">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="<?php echo e(CustomHelper::getCompanyLogo($id)); ?>" alt=""
                                ...
                                <div class="p-2">
                                    <form method="POST" class="form-horizontal" action="<?php echo e(route('storeClientRegister',$id)); ?>" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('first_name')); ?>" id="username" name="first_name" autofocus required
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('last_name')); ?>" id="username" name="last_name" autofocus required
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-0">By registering you agree to the <?php echo e(CustomHelper::getThemeSetting($id)); ?> <a href="#"
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/auth1/register.blade.php ENDPATH**/ ?>