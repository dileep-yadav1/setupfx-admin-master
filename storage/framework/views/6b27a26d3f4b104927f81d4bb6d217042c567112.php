...
<?php $__env->slot('title'); ?> Ticket List <?php $__env->endSlot(); ?>
                        ...
                        <div class="pt-4">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <h5 class="btn text-white waves-effect waves-light bg-<?php echo e(($aRow->status == 0)? 'danger' : 'success'); ?>"><?php echo e(($aRow->status == 0)? 'Pending' : 'Closed'); ?></h5>
                                </div>
                                <div class="col-6">
                                    <p class="text-muted mb-0">Total Replies</p>
                                    <h5 class="font-size-15 text-center text-white bg-primary rounded p-1"><span class=""><?php echo e(count($areply)); ?></span></h5>
                                </div>
                            </div>
                        ...
                        <a href="javascript: void(0);" class="text-body">
                            <div class="p-2">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-2 pt-4">
                                        <p class="text-muted"><?php echo e(CustomHelper::getDepartmentName($aRow->department)); ?></p>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="javascript: void(0);" class="text-body">
                            <div class="p-2">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-2 pt-4">
                                        <p class="text-muted"><?php echo e(($aRow->reporter != '')? Client::$getSalesAgent[$aRow->reporter] : '--'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </a>
    ...
    <div class="w-100 user-chat">
        <div class="card">
            ...
            <div>
                                ...
                                <li class="<?php echo e(($aKey == count($areply)-1)? 'chat-window' : ''); ?>">
                                    <div class="conversation-list">
                                        ...
                                        <div class="ctext-wrap">
                                            ...
                                            <p class="chat-time mb-0"><i class="bx bx-time-five align-middle me-1"></i> <?php echo e($aValue->created_at); ?></p>
                                        </div>
                                    </div>
                                </li>
                            <?php else: ?>
                ...
                <form action="<?php echo e(route('client-ticket.saveReply')); ?>" enctype="multipart/form-data" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/clientTicket/chat.blade.php ENDPATH**/ ?>