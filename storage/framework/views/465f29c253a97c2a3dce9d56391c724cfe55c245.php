<?php $__env->startSection('title'); ?> <?php if($aRow): ?> Edit <?php else: ?> Add <?php endif; ?> Appointment <?php $__env->stopSection(); ?>
...
<?php $__env->startComponent('components.breadcrumb'); ?>
    ...
    <?php $__env->slot('title'); ?> <?php if($aRow): ?> Edit <?php else: ?> Add <?php endif; ?> Appointment <?php $__env->endSlot(); ?>
...
<div class="row">
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                <?php if($aRow): ?>
                <form method="POST"  action="<?php echo e(route('calendar.appointment.update',$aRow->id)); ?>" enctype="multipart/form-data">
                
                <?php else: ?>
                <form method="POST"  action="<?php echo e(route('calendar.appointment.store')); ?>" enctype="multipart/form-data">
                <?php endif; ?>
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/tools/calendar/addAppointment.blade.php ENDPATH**/ ?>