            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="basic-example">
                        ...
                        <section>
                            <?php if($aRow): ?>
                                <form action="<?php echo e(route('email_campaign.update', $aRow->id)); ?>" method="POST"
                                    enctype="multipart/form-data">
                                    <?php echo method_field('PUT'); ?>
                                <?php else: ?>
                                    <form action="<?php echo e(route('email_campaign.store')); ?>" method="POST"
                                        enctype="multipart/form-data" id="lead-form">
                            <?php endif; ?>
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="from_name" id="from_name" class="form-control" value="<?php echo e($aRow ? $aRow->from_name : ''); ?>"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="from_email" id="from_email" class="form-control" value="<?php echo e($aRow ? $aRow->from_email : ''); ?>"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="reply_to" id="reply_to" class="form-control" value="<?php echo e($aRow ? $aRow->reply_to : ''); ?>"
                                            placeholder="Enter Reply To Email" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="campaign_name" id="campaign_name" class="form-control" value="<?php echo e($aRow ? $aRow->campaign_name : ''); ?>"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="formrow-email-input" class="form-label">Body</label>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="basicpill-address-input">Test Emails(Multiple Emails comma
                                            seperated)</label><br>
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo e($aRow ? $aRow->test_emails : ''); ?>"
                                                data-role="tagsinput" name="test_emails" class="form-control"
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <input type="checkbox" name="send_mail" id="send_mail" value="1"
                                            placeholder="Enter Name">&nbsp;<label for="basicpill-firstname-input">Send
                                            Test Mail</label>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/marketing/email-add.blade.php ENDPATH**/ ?>