...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mt-4 text-center">
                                            <a href="<?php echo e(url('client/register/1')); ?>" class="fw-medium btn btn-primary w-100"> Register as Client </a>
                                        </div>
                                        <div class="mt-4 text-center">
                                            <a href="<?php echo e(url('ib/register/1')); ?>" class="fw-medium btn btn-primary w-100"> Register as IB </a>
                                        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/auth/login.blade.php ENDPATH**/ ?>