...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.Ticket_List'); ?>
            ...
            <div id="collapseOne" class="accordion-collapse collapse <?php echo e($showFilter); ?>" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                <div class="accordion-body">
                    <div class="text-muted">
                        <form method="GET" action="<?php echo e(route('ticket.index')); ?>">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <a href="<?php echo e(route('ticket.index')); ?>" class="btn btn-danger w-md">Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card-body">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_ticket_create')): ?>
                        <div class="d-flex flex-wrap gap-2 mb-4 justify-content-md-end">
                            <a class="btn btn-primary waves-effect waves-light" href="<?php echo e(route('ticket.create')); ?>"
                            ...
                            <table class="table align-middle table-nowrap table-hover">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_ticket_status')): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-inline font-size-20 contact-links mb-0">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_ticket_reply')): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/ticket/index.blade.php ENDPATH**/ ?>