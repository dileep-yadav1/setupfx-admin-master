        ...
        <div class="tab-pane active" id="overview" role="tabpanel">
            <div class="d-lg-flex">
                            ...
                            <div class="container mt-4">
                                ...
                                <div class="row mt-3">
                                    <?php if(!$user->email_verified_at): ?>
                                        <a href="<?php echo e(route('sendVerificationMail', $aRow->id)); ?>"
                                ...
                                <div class="row mt-3">
                                    <?php if($aRow->status = 2): ?>
                                        <a href="<?php echo e(route('sendDocumentMail',$aRow->id)); ?>" class="btn btn-primary"><i class="fas fa-envelope"></i>&nbsp;Send
                                            Doc Reminder</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                                    ...
                                    <?php if($activity): ?>
                                        <div class="comment-list block m-sm">
                                            <div class="scrollable">
                                                <ul class="list-group">
                                                    <?php $__currentLoopData = $activity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($value->activity_type == CustomHelper::ACTIVITYDOCUMENT): ?>
                                                            <li class="list-item mb-3">
                                                                <div class="row">
                                                                    <div class="col-md-2">
                                                                        <img src="<?php echo e(CustomHelper::getCompanyLogo(Auth::user()->admin_id)); ?>"
                ...
                <div class="chat-leftsidebar me-lg-8 col-xl-8">
                    ...
                    <div class="mt-3">
                        <form action="<?php echo e(route('comments.saveleadreply')); ?>" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-11 p-3">
                                    <input type="hidden" name="client_id" value="<?php echo e($aRow->id); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/clients/Overview.blade.php ENDPATH**/ ?>