            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="<?php echo e(CustomHelper::displayImage(Auth::user()->avatar)); ?>" alt="Header Avatar">
...
<?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>