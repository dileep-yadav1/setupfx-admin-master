            ...
            <div class="card overflow-hidden">
                <div class="card-body">
                    <table class="table align-middle table-nowrap table-hover">
                        ...
                        <tbody>
                            <?php if($message): ?>
                                <?php $__currentLoopData = $message; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e(++$key); ?></td>
                                        <td><?php echo $msg->message; ?></td>
                                        <td><?php echo e($msg->reply_by); ?></td>
                                        <td><?php echo e(date('d M,Y',strtotime($msg->created_at))); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/setupfx-admin-master/resources/views/staff/Message.blade.php ENDPATH**/ ?>