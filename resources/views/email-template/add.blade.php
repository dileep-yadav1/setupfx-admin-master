                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        {{ Form::select('emailtype', ['' => 'Please Select'] + $emailType, $aRow ? $aRow->emailtype : null, ['class' => 'form-control', 'required' => 'required']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        <span class="mb-4"><i class="bx bxs-info-circle"></i>You can use any of these
                                            ...
                                            @foreach ($mailVariable as $variable)
                                                ...
                                                <button type="button" onclick="copyVariable('variableCopy{{ $variable->id }}')"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="{{ $aRow ? $aRow->tags : '' }}"
