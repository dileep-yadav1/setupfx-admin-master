                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="mt-4 text-center">
                                            <a href="{{ url('client/register/1') }}" class="fw-medium btn btn-primary w-100"> Register as Client </a>
                                        </div>
                                        <div class="mt-4 text-center">
                                            <a href="{{ url('ib/register/1') }}" class="fw-medium btn btn-primary w-100"> Register as IB </a>
                                        </div>
