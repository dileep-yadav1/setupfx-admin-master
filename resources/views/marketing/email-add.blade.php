            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="basic-example">
                        ...
                        <section>
                            @if ($aRow)
                                <form action="{{ route('email_campaign.update', $aRow->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @method('PUT')
                                @else
                                    <form action="{{ route('email_campaign.store') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="from_name" id="from_name" class="form-control" value="{{ $aRow ? $aRow->from_name : '' }}"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="from_email" id="from_email" class="form-control" value="{{ $aRow ? $aRow->from_email : '' }}"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="reply_to" id="reply_to" class="form-control" value="{{ $aRow ? $aRow->reply_to : '' }}"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="campaign_name" id="campaign_name" class="form-control" value="{{ $aRow ? $aRow->campaign_name : '' }}"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="taskdesc-editor" class="mt-3" rows="{{ $aRow ? '20' : '' }}" name="message">{{ $aRow ? $aRow->message : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="basicpill-address-input">Test Emails(Multiple Emails comma
                                            seperated)</label><br>
                                        <div class="col-md-12">
                                            <input type="text" value="{{ $aRow ? $aRow->test_emails : '' }}"
