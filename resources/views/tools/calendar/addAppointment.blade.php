...
@section('title') @if($aRow) Edit @else Add @endif Appointment @endsection
...
@component('components.breadcrumb')
    ...
    @slot('title') @if($aRow) Edit @else Add @endif Appointment @endslot
@endcomponent
...
<div class="row">
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                @if($aRow)
                <form method="POST"  action="{{ route('calendar.appointment.update',$aRow->id) }}" enctype="multipart/form-data">
                {{-- @method('PUT') --}}
                @else
                <form method="POST"  action="{{ route('calendar.appointment.store') }}" enctype="multipart/form-data">
                @endif
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
