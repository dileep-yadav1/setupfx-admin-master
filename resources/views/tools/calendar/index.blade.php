        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-grid">
                            {{-- <button class="btn font-16 btn-primary mb-1" id="btn-new-event"><i class="mdi mdi-plus-circle-outline"></i> Add Event</button> --}}
                            <a href="{{ route('calendar.event.create') }}" class="btn font-16 btn-primary mb-1"><i class="mdi mdi-plus-circle-outline"></i> Add Event</a>
                            <a href="{{ route('calendar.appointment.create') }}" class="btn font-16 btn-primary mb-1"><i class="mdi mdi-plus-circle-outline"></i> Appointments</a>
                        </div>
...
var defaultEvents = [
    ...
    {
        title : "{{ $task->title }}",
        start : "{{ $task->start_date }}", // please specify dates in milliseconds, not seconds
        end : "{{ $task->end_date }}",
        backgroundColor : "{{ $task->event_color }}",
        // start: new Date(y, m, d, 12, 0),
        // end: new Date(y, m, d, 14, 0),
        // allDay: false,
        // className: 'bg-danger',
        url: "{{ ($task->type == 1) ? route('todo.edit', $task->id) : route('calendar.appointment.edit', $task->id) }}",
    },
    @endforeach
];
