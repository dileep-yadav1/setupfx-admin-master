...
@section('content')
    ...
    <div class="d-lg-flex">
                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            <div class="col-md-1">
                                                ...
                                                @endphp
                                                <a
                                                    href="{{ Auth::user()->role_id == config('constant.ADMIN_ROLE') ? url('staff/' . $aRow->user_id . '/' . $key) : '#' }}">
        ...
        <div class="chat-leftsidebar me-lg-9 col-xl-9">
            ...
            <div class="mt-3">
                <form action="{{ route('messages.saveadminreply') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-1">
