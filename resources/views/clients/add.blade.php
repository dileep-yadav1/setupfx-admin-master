    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    @if ($aRow)
                        <form method="POST" action="{{ route('leads.update', $aRow->id) }}" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        {{ Form::select('country_id', ['' => 'Please Select'] + $aCountry, $aRow ? $aRow->country : null, ['id' => 'country-dropdown', 'class' => 'form-control', 'required' => 'required']) }}
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="mb-3">
