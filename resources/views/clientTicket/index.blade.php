...
@section('title')
    @lang('translation.Client Ticket List')
@endsection
            ...
            <div id="collapseOne" class="accordion-collapse collapse {{$showFilter}}" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style="">
                <div class="accordion-body">
                    <div class="text-muted">
                        <form method="GET" action="{{ route('client-ticket.index') }}">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <a href="{{ route('client-ticket.index') }}" class="btn btn-danger w-md">Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card-body">
                    @can('client_ticket_create')
                        <div class="d-flex flex-wrap gap-2 mb-4 justify-content-md-end">
                            <a class="btn btn-primary waves-effect waves-light" href="{{ route('client-ticket.create') }}"
                                    ...
                                    @foreach ($aTickets as $aKey => $aTicket)
                                        <tr>
                                            ...
                                            @can('client_ticket_status')
                                                <td>
                                                    @if ($aTicket->status == 0)
                                                        <a href="{{ route('client-ticket.change_status', [$aTicket->id, 1]) }}">
                                            ...
                                            <td>
                                                <ul class="list-inline font-size-20 contact-links mb-0">
                                                    @can('client_ticket_reply')
                                                        @if (Auth::user()->role_id == config('constant.ADMIN_ROLE'))
                                                            <li class="list-inline-item">
                                                                <a href="{{ route('admin_client-ticket.reply', $aTicket->id) }}" title="Reply">
