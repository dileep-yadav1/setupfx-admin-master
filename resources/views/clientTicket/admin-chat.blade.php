                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="avatar-md profile-user-wid mb-4">
                                ...
                                @endphp
                                <img src="{{ $logo }}" alt="" class="img-thumbnail rounded-circle">
                            </div>
                            ...
                            <div class="pt-4">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <h5
                                            class="btn text-white waves-effect waves-light bg-{{ $aRow->status == 0 ? 'danger' : 'success' }}">
                                            {{ $aRow->status == 0 ? 'Pending' : 'Closed' }}</h5>
                                    </div>
                                    <div class="col-6">
                                        <p class="text-muted mb-0">Total Replies</p>
                                        <h5 class="font-size-15 text-center text-white bg-primary rounded p-1"><span
                                                class="">{{ count($areply) }}</span></h5>
                                    </div>
                                </div>
                                {{-- <div class="mt-4">
                            ...
                            <a href="javascript: void(0);" class="text-body">
                                <div class="p-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-2 pt-4">
                                            <p class="text-muted">{{ CustomHelper::getDepartmentName($aRow->department) }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="javascript: void(0);" class="text-body">
                                <div class="p-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-2 pt-4">
                                            <p class="text-muted">
                                                {{ $aRow->reporter != '' ? Client::$getSalesAgent[$aRow->reporter] : '--' }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="w-100 user-chat">
            <div class="card">
                ...
                <div>
                    ...
                    @if ($aRow->status == 0)
                        <form action="{{ route('admin_client-ticket.saveReply') }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
